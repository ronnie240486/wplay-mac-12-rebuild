...
.field private final futures:Ly9/u1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ly9/u1;"
        }
...
# direct methods
.method private constructor <init>(ZLy9/u1;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    .line 4
    iput-object p2, p0, Lcom/google/common/util/concurrent/Futures$FutureCombiner;->futures:Ly9/u1;

    return-void
.end method

.method public synthetic constructor <init>(ZLy9/u1;Lcom/google/common/util/concurrent/Futures$1;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Lcom/google/common/util/concurrent/Futures$FutureCombiner;-><init>(ZLy9/u1;)V
...
.method public call(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 2
    .line 3
    iget-object v1, p0, Lcom/google/common/util/concurrent/Futures$FutureCombiner;->futures:Ly9/u1;
    ...
    .line 6
    .line 7
    invoke-direct {v0, v1, v2, p2, p1}, Lcom/google/common/util/concurrent/CombinedFuture;-><init>(Ly9/q1;ZLjava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)V
...
.method public callAsync(Lcom/google/common/util/concurrent/AsyncCallable;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 6
    .line 7
    invoke-direct {v0, v1, v2, p2, p1}, Lcom/google/common/util/concurrent/CombinedFuture;-><init>(Ly9/q1;ZLjava/util/concurrent/Executor;Lcom/google/common/util/concurrent/AsyncCallable;)V
