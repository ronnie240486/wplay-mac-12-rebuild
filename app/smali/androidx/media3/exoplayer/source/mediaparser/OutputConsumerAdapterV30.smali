...
.method private static toExoPlayerDrmInitData(Ljava/lang/String;Landroid/media/DrmInitData;)Landroidx/media3/common/DrmInitData;
    ...
    .line 5
    :cond_0
    invoke-static {p1}, Landroidx/media3/exoplayer/hls/j;->a(Landroid/media/DrmInitData;)I
    ...
    .line 13
    .line 14
    invoke-static {p1, v2}, Landroidx/media3/exoplayer/hls/j;->f(Landroid/media/DrmInitData;I)Landroid/media/DrmInitData$SchemeInitData;
    ...
    .line 19
    .line 20
    invoke-static {v3}, Landroidx/media3/exoplayer/hls/j;->p(Landroid/media/DrmInitData$SchemeInitData;)Ljava/util/UUID;
    ...
    .line 24
    invoke-static {v3}, Landroidx/media3/exoplayer/mediacodec/c;->i(Landroid/media/DrmInitData$SchemeInitData;)Ljava/lang/String;
    ...
    .line 28
    invoke-static {v3}, Landroidx/media3/exoplayer/mediacodec/c;->x(Landroid/media/DrmInitData$SchemeInitData;)[B
...
.method private toExoPlayerFormat(Landroid/media/MediaParser$TrackData;)Landroidx/media3/common/Format;
    ...
    .line 1
    invoke-static {p1}, Landroidx/media3/exoplayer/hls/j;->h(Landroid/media/MediaParser$TrackData;)Landroid/media/MediaFormat;
    ...
    .line 11
    invoke-static {v0}, Landroidx/media3/exoplayer/mediacodec/i;->r(Landroid/media/MediaFormat;)I
    ...
    .line 26
    invoke-static {p1}, Landroidx/media3/exoplayer/hls/j;->g(Landroid/media/MediaParser$TrackData;)Landroid/media/DrmInitData;
    ...
    .line 52
    invoke-static {v0}, Landroidx/media3/exoplayer/mediacodec/i;->o(Landroid/media/MediaFormat;)I
    ...
    .line 90
    invoke-static {v0}, Landroidx/media3/exoplayer/mediacodec/i;->s(Landroid/media/MediaFormat;)I
    ...
    .line 98
    invoke-static {v0}, Landroidx/media3/exoplayer/mediacodec/i;->v(Landroid/media/MediaFormat;)I
    ...
    .line 180
    invoke-static {v0}, Landroidx/media3/exoplayer/mediacodec/i;->n(Landroid/media/MediaFormat;)F
...
.method public getSeekPoints(J)Landroid/util/Pair;
    ...
    .line 4
    .line 5
    invoke-static {v0, p1, p2}, Landroidx/media3/exoplayer/hls/j;->m(Landroid/media/MediaParser$SeekMap;J)Landroid/util/Pair;
...
.method public onSampleDataFound(ILandroid/media/MediaParser$InputReader;)V
    ...
    .line 31
    .line 32
    invoke-static {p2}, Landroidx/media3/exoplayer/hls/j;->c(Landroid/media/MediaParser$InputReader;)J
...
.method public onSeekMapFound(Landroid/media/MediaParser$SeekMap;)V
    ...
    .line 13
    .line 14
    invoke-static {p1}, Landroidx/media3/exoplayer/hls/j;->d(Landroid/media/MediaParser$SeekMap;)J
...
.method public onTrackDataFound(ILandroid/media/MediaParser$TrackData;)V
    ...
    .line 1
    invoke-static {p2}, Landroidx/media3/exoplayer/hls/j;->h(Landroid/media/MediaParser$TrackData;)Landroid/media/MediaFormat;
